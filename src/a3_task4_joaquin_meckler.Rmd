...
To better understand this relationship, we use two sample t-test. With this, we get a p value of .2536. This is the probability of getting 2 sample means that are least as different as the sample means we got from our annual and control treatment datasets. Since we have a relatively high p-value, there is less evidence of difference between populations means. This point is further support by our means found in the summary table, which have an actual difference of .19cm. Thus, we cannot reject the null hypothesis based on our calculated p-value.
ADD STUFF ABOUT CONFIDENCE INTERVAL
